...
namespace PedigreeManagement
{
    ...
    public partial class App : Application
    {
        ...
        private static int LowLevelKeyboardProc(int nCode, int wParam, ref KBDLLHOOKSTRUCT lParam)
        {
            if (nCode >= 0)
                switch (wParam)
                {
                    ...
                    case 261: // M_SYSKEYUP
                        if ((lParam.vkCode == 0x09 && lParam.flags == 32) || // Alt+Tab
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            {
                MessageBox.Show((string)Application.Current.FindResource("DisableMultipleAPP"));
                this.Shutdown();
            }
        }
